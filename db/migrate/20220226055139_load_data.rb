class LoadData < ActiveRecord::Migration[7.0]
  def up
    # Create initial users.
    down
    jb = User.new(:first_name => "Pravesh", :last_name => "Jain")
    jb.save(:validate => false)
    ph = User.new(:first_name => "Sankalp",  :last_name => "Kasale")
    ph.save(:validate => false)
    mt = User.new(:first_name => "Khadija",  :last_name => "Hasta")
    mt.save(:validate => false)
    bo = User.new(:first_name => "Harsh", :last_name => "Jobanputra")
    bo.save(:validate => false)
    sc = User.new(:first_name => "Atharva", :last_name => "Pashankar")
    sc.save(:validate => false)
    jo = User.new(:first_name => "Krishna", :last_name => "Bhanderi")
